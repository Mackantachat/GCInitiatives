...
Log in User New Initiatives Max
    ...
    Scroll Element Into View         xpath=//label[contains(text(),'Is this Initiative involve IT & digital')]
    Wait Until Element Is Visible    xpath=//label[contains(text(),'Is this Initiative involve IT & digital')]    30
    click                            xpath=//label[contains(text(),'Is this Initiative involve IT & digital')]
    ...
    Wait Until Element Is Visible    xpath=//span[contains(text(),'Digital CAPEX')]            50
    click                            xpath=//span[contains(text(),'Digital CAPEX')]
