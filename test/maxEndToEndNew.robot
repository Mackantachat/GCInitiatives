...
*** Variables ***
${browser}                 chrome
${url}                     https://gcinitiative-front-dev.azurewebsites.net/
${url1}                    https://gcinitiative-front-dev.azurewebsites.net/
${username}                z0007155@pttgcgroup.com
${password}                Aa+12345
${username1}               z0007141@pttgcgroup.com
${password1}               3#Weedas
${Approveruser1}           z0007155@pttgcgroup.com
${Approverpass1}           Aa+12345
${Approveruser2}           z0007142@pttgcgroup.com
${Approverpass2}           2#First136969
${selspeed}                0.5s
${initiativeCode}          null
${runRate(M.THB)}          null
...
Log in User New Initiatives Max
    ...
    Wait Until Element Is Visible          xpath=//button[contains(text(),'Submit')]                                                                                        30
    ...
    # Input Plant = 1021 - AROMATICS I - A-P1   11 != 10
    ...
    # back to general tab
    Sleep                                  3                                                                                                                                second
    Wait Until Element Is Visible          xpath=//span[contains(text(),'General Information')]
    Scroll Element Into View               xpath=//span[contains(text(),'General Information')]
    click                                  xpath=//span[contains(text(),'General Information')]
    ...
    # go to detail tab
    Sleep                                  5                                                                                                                                second
    click                                  xpath=//span[contains(text(),' Detail Information ')]
    ...
    Wait Until Element Is Visible          xpath=//option[@value="CAPEX"]                                                                                                   50
    Click                                  xpath=//option[@value="CAPEX"]
    Sleep                                  3                                                                                                                                seconds
    ...
    Wait Until Element Is Visible          xpath=//option[@value="CAPEX - GCME"]                                                                                            50
    Click                                  xpath=//option[@value="CAPEX - GCME"]
    Sleep                                  1 seconds
    ...
    Wait Until Element Is Visible          xpath=//option[contains(text(),' Akrapon.S <xx>')]                                                                               50
    Click                                  xpath=//option[contains(text(),' Akrapon.S <xx>')]
    Sleep                                  1 seconds
    ...
    # Tab Impact Tracking
    Sleep                                  3                                                                                                                                second
    Scroll Element Into View               xpath=//span[contains(text(),'Impact Tracking')]
    Wait Until Element Is Visible          xpath=//span[contains(text(),'Impact Tracking')]                                                                                 50
    click                                  xpath=//span[contains(text(),'Impact Tracking')]
    Sleep                                  3                                                                                                                                second
    ...
    # AUG 2020
    Scroll Element Into View               xpath=//table[@class="table table-bordered impact-table"]//tr[@class="ng-star-inserted"][1]//input[@ng-reflect-name="month1"]
    Wait Until Element Is Visible          xpath=//table[@class="table table-bordered impact-table"]//tr[@class="ng-star-inserted"][1]//input[@ng-reflect-name="month1"]    50
    click                                  xpath=//table[@class="table table-bordered impact-table"]//tr[@class="ng-star-inserted"][1]//input[@ng-reflect-name="month1"]
    type                                   xpath=//table[@class="table table-bordered impact-table"]//tr[@class="ng-star-inserted"][1]//input[@ng-reflect-name="month1"]    3.443
    ...
    # Tab Impact Tracking
    Sleep                                  3                                                                                                                                second
    Scroll Element Into View               path=//span[contains(text(),'Impact Tracking')]
    Wait Until Element Is Visible          path=//span[contains(text(),'Impact Tracking')]                                                                                  50
    click                                  path=//span[contains(text(),'Impact Tracking')]
    Sleep                                  3                                                                                                                                second
    ...
    # Tab "Progress"
    Scroll Element Into View               xpath=//span[contains(text(),' Progress ')]
    Wait Until Element Is Visible          xpath=//span[contains(text(),' Progress ')]                                                                                      50
    click                                  xpath=//span[contains(text(),' Progress ')]
    Sleep                                  3                                                                                                                                second
