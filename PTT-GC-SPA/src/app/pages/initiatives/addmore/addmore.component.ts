import { Component, OnInit, Output, EventEmitter, Input, OnDestroy, ViewChild, ViewEncapsulation } from '@angular/core';
...
export class AddmoreComponent implements OnInit, OnDestroy {
  ...
  initiativesForm = this.fb.group({
    ...
    company: null,
    specifyCompany: { value: null, disabled: true },
    coDeveloper: { value: null, disabled: true },
    integration: { value: null, disabled: true },
    plant: { value: null, disabled: true },
    specifyPlant: { value: null, disabled: true },
    location: { value: null, disabled: true },
    specifyLocation: { value: null, disabled: true },
    registeringDate: { value: null, disabled: true },
    startingDate: { value: null, disabled: true },
    finishingDate: { value: null, disabled: true },
    background: ['', Validators.required],
    resultObjective: ['', Validators.required],
    scopeOfWork: ['', Validators.required],
    initiativeType: { value: null, disabled: true },
    requestCapex: { value: null, disabled: true },
    typeOfInvestment: { value: null, disabled: true },
    involveItDigital: { value: null, disabled: true },
    requestProjectEngineer: { value: null, disabled: true },
    budgetType: { value: null, disabled: true },
    ram: { value: null, disabled: true },
    jFactor: { value: null, disabled: true },
    irr: { value: null, disabled: true },
    wacc: [8.53],
    costEstCapex: { value: null, disabled: true },
    costEstCapexType: { value: null, disabled: true },
    divestment: { value: null, disabled: true },
    budgetSource: { value: null, disabled: true },
    requestOpex: { value: null, disabled: true },
    costEstOpex: { value: null, disabled: true },
    costEstOpexType: { value: null, disabled: true },
    typeBenefit: { value: null, disabled: true },
    benefitAmount: { value: null, disabled: true },
    benefitAmountType: { value: null, disabled: true },
    payBackPeriod: { value: null, disabled: true },
    fxExchange: { value: null, disabled: true },
  ...
  get invalidName() {
    return (
      this.initiativesForm.controls.name.touched &&
      this.initiativesForm.controls.name.invalid
    );
  }

  get invalidOwnerName() {
    return (
      this.initiativesForm.controls.ownerName.touched &&
      this.initiativesForm.controls.ownerName.invalid
    );
  }

  get invalidOrganization() {
    return (
      this.initiativesForm.controls.organization.touched &&
      this.initiativesForm.controls.organization.invalid
    );
  }

  get invalidPlant() {
    return (
      this.initiativesForm.controls.plant.touched &&
      this.initiativesForm.controls.plant.invalid
    );
  }

  get invalidBackground() {
    return (
      this.initiativesForm.controls.background.touched &&
      this.initiativesForm.controls.background.invalid
    );
  }

  get invalidResultObjective() {
    return (
      this.initiativesForm.controls.resultObjective.touched &&
      this.initiativesForm.controls.resultObjective.invalid
    );
  }

  get invalidScopeOfWork() {
    return (
      this.initiativesForm.controls.scopeOfWork.touched &&
      this.initiativesForm.controls.scopeOfWork.invalid
    );
  }

  get invalidTypeOfInvestment() {
    return (
      this.initiativesForm.controls.typeOfInvestment.touched &&
      this.initiativesForm.controls.typeOfInvestment.invalid
    );
  }

  get invalidStartingDate() {
    return (
      this.initiativesForm.controls.finishingDate.touched &&
      this.initiativesForm.controls.finishingDate.invalid
    );
  }

  get invalidCostEstCapex() {
    return (
      this.initiativesForm.controls.costEstCapex.touched &&
      this.initiativesForm.controls.costEstCapex.invalid
    );
  }

  get invalidCostEstOpex() {
    return (
      this.initiativesForm.controls.costEstOpex.touched &&
      this.initiativesForm.controls.costEstOpex.invalid
    );
  }

  get invalidTypeOfBenefit() {
    return (
      this.initiativesForm.controls.typeBenefit.touched &&
      this.initiativesForm.controls.typeBenefit.invalid
    );
  }

  get invalidBenefitAmount() {
    return (
      this.initiativesForm.controls.benefitAmount.touched &&
      this.initiativesForm.controls.benefitAmount.invalid
    );
  }

  get invalidPayBack() {
    return (
      this.initiativesForm.controls.payBackPeriod.touched &&
      this.initiativesForm.controls.payBackPeriod.invalid
    );
  }

  get invalidBudget() {
    return (
      this.initiativesForm.controls.budgetType.touched &&
      this.initiativesForm.controls.budgetType.invalid
    );
  }

  get invalidJFactor() {
    return (
      this.initiativesForm.controls.jFactor.touched &&
      this.initiativesForm.controls.jFactor.invalid
    );
  }

  get invalidFX() {
    return (
      this.initiativesForm.controls.fxExchange.touched &&
      this.initiativesForm.controls.fxExchange.invalid
    );
  }

  get invalidRam() {
    return (
      this.initiativesForm.controls.ram.touched &&
      this.initiativesForm.controls.ram.invalid
    );
  }

  get invalidIrr() {
    return (
      this.initiativesForm.controls.irr.touched &&
      this.initiativesForm.controls.irr.invalid
    );
  }

  get invalidCompany() {
    return (
      this.initiativesForm.controls.company.touched &&
      this.initiativesForm.controls.company.invalid
    );
  }
  ...
  ngOnInit(): void {
    ...
    this.GetYears();
    this.isAddMoreGeneral();
    setTimeout(() => this.GetInitiative(), 200);
    this.id = Number(sessionStorage.getItem('id'));
    sessionStorage.setItem('page', 'addmore-general');
    this.GetCompany();
  }

  ngOnDestroy(): void {
    sessionStorage.setItem('AddMoreGeneralValidate', JSON.stringify(this.invalidSubmit));
    if (this.initiativesForm.dirty) {
      this.initiativesForm.enable();
      sessionStorage.setItem('isAddMoreGeneral', 'true');
      sessionStorage.setItem('AddMoreGeneral', JSON.stringify(this.initiativesForm.value));
    }
  }
  ...
  GetUser() {
    this.authService.getMsalUser().subscribe(
      (response) => {
  ...
  ValidateForm(FormControl) {
    if (FormControl.includes('investment')) {
      this.initiativesForm.controls.typeOfInvestment.setValidators([
        Validators.required,
      ]);
      this.initiativesForm.controls.typeOfInvestment.updateValueAndValidity();
    }
    if (FormControl.includes('budgetType')) {
      this.initiativesForm.controls.budgetType.setValidators([
        Validators.required,
      ]);
    ...
    if (FormControl.includes('jFactor')) {
      this.initiativesForm.controls.jFactor.setValidators([
        Validators.required,
      ]);
    ...
    if (FormControl.includes('benefitAmount')) {
      this.initiativesForm.controls.benefitAmount.setValidators([
        Validators.required,
      ]);
      this.initiativesForm.controls.benefitAmount.updateValueAndValidity();
    }
    if (FormControl.includes('payBackPeriod')) {
      this.initiativesForm.controls.payBackPeriod.setValidators([
        Validators.required,
      ]);
  ...
  EnableForm(FormControl) {
    ...
    if (FormControl.includes('budgetType')) {
      this.initiativesForm.controls.budgetType.enable();
    }
    if (FormControl.includes('ram')) {
      this.initiativesForm.controls.ram.enable();
    }
    if (FormControl.includes('jFactor')) {
      this.initiativesForm.controls.jFactor.enable();
    }
    if (FormControl.includes('irr')) {
      this.initiativesForm.controls.irr.enable();
    }
    if (FormControl.includes('fxExchange')) {
      this.initiativesForm.controls.fxExchange.enable();
    }
    if (FormControl.includes('costEstCapex')) {
      this.initiativesForm.controls.costEstCapex.enable();
    }
    if (FormControl.includes('costEstOpex')) {
      this.initiativesForm.controls.costEstOpex.enable();
    }
    if (FormControl.includes('costEstCapexType')) {
      this.initiativesForm.controls.costEstCapexType.enable();
    }
    if (FormControl.includes('costEstOpexType')) {
      this.initiativesForm.controls.costEstOpexType.enable();
    }
    if (FormControl.includes('budgetSource')) {
      this.initiativesForm.controls.budgetSource.enable();
    }
    if (FormControl.includes('typeBenefit')) {
      this.initiativesForm.controls.typeBenefit.enable();
    }
    if (FormControl.includes('wacc')) {
      this.initiativesForm.controls.wacc.enable();
    }
    if (FormControl.includes('benefitAmount')) {
      this.initiativesForm.controls.benefitAmount.enable();
    }
    if (FormControl.includes('payBackPeriod')) {
      this.initiativesForm.controls.payBackPeriod.enable();
    }
  }
  ...
  OnChangeTypeOfInvestment() {
    ...
    this.CheckTypeOfInvestment(
      this.initiativesForm.controls.typeOfInvestment.value
    );
  ...
  CalculatePayBackPeriod() {
    ...
    const result =
      (Number(costEstCapex) + Number(costEstOpex)) / Number(benefitAmount);
    this.initiativesForm.patchValue({
      payBackPeriod: isFinite(result) ? result : null,
    });
  }
  ...
  DisableForm(FormControl) {
    if (FormControl.includes('investment')) {
      this.initiativesForm.controls.typeOfInvestment.disable();
    }
    if (FormControl.includes('budgetType')) {
      this.initiativesForm.controls.budgetType.disable();
    }
    if (FormControl.includes('ram')) {
      this.initiativesForm.controls.ram.disable();
    }
    if (FormControl.includes('jFactor')) {
      this.initiativesForm.controls.jFactor.disable();
    }
    if (FormControl.includes('irr')) {
      this.initiativesForm.controls.irr.disable();
    }
    if (FormControl.includes('fxExchange')) {
      this.initiativesForm.controls.fxExchange.disable();
    }
    if (FormControl.includes('costEstCapex')) {
      this.initiativesForm.controls.costEstCapex.disable();
    }
    if (FormControl.includes('costEstOpex')) {
      this.initiativesForm.controls.costEstOpex.disable();
    }
    if (FormControl.includes('costEstCapexType')) {
      this.initiativesForm.controls.costEstCapexType.disable();
    }
    if (FormControl.includes('costEstOpexType')) {
      this.initiativesForm.controls.costEstOpexType.disable();
    }
    if (FormControl.includes('budgetSource')) {
      this.initiativesForm.controls.budgetSource.disable();
    }
    if (FormControl.includes('typeBenefit')) {
      this.initiativesForm.controls.typeBenefit.disable();
    }
    if (FormControl.includes('wacc')) {
      this.initiativesForm.controls.wacc.disable();
    }
    if (FormControl.includes('benefitAmount')) {
      this.initiativesForm.controls.benefitAmount.disable();
    }
    if (FormControl.includes('payBackPeriod')) {
      this.initiativesForm.controls.payBackPeriod.disable();
    }
  }

  ShowForm(FormControl) {
    if (FormControl.includes('investment')) {
      this.showTypeOfInvestment = true;
    }
    if (FormControl.includes('budgetType')) {
    ...
    if (FormControl.includes('costEstCapexType')) {
      this.showCostEstCapexType = true;
    }
    if (FormControl.includes('typeBenefit')) {
      this.showTypeBenefit = true;
    }
  ...
  HideForm(FormControl) {
    ...
    if (FormControl.includes('costEstOpexType')) {
      this.showCostEstOpexType = false;
    }
    if (FormControl.includes('budgetSource')) {
      this.showBudgetSource = false;
    }
    if (FormControl.includes('typeBenefit')) {
      this.showTypeBenefit = false;
    }
      ...
      this.authService.getMsalUser().subscribe(
        (user) => {
          ...
          this.initiativeService
            .GetOwnerName(this.params)
            .subscribe((owners) => {
              if (
                user.mail === owners.email ||
                user.mail === createdBy
              ) {
    ...
    if (sessionStorage.getItem('isAddMoreGeneral') !== 'true') {
      this.initiativeService.GetInitiative(this.id).subscribe((response) => {
        ...
        this.coDeveloperSelected.forEach((element) => {
          if (element.coDeveloperName) {
            this.selectListCoDeveloper.push(element.coDeveloperName);
          }
        });
        ...
        this.dateRegisterDisplay = this.dateUtil.GetDate(
          new Date(response.registeringDate)
        );
        this.dateStartDisplay = this.dateUtil.GetDate(
          new Date(response.startingDate)
        );
        this.dateFinishDisplay = response.finishingDate
          ? this.dateUtil.GetDate(new Date(response.finishingDate))
          : null;
        this.initiativesForm.patchValue({
          ...
          costEstCapex:
            response.costEstCapex !== 0 ? response.costEstCapex : null,
          benefitAmount:
            response.benefitAmount !== 0 ? response.benefitAmount : null,
          fxExchange: response.fxExchange !== 0 ? response.fxExchange : null,
          payBackPeriod:
            response.payBackPeriod !== 0 ? response.payBackPeriod : null,
        });
        ...
        if (response.benefitAmount) {
          this.impactService
            .GetImpactTotalRecurringOneTime(this.id)
            .subscribe((result) => {
              if (result) {
                if (result !== 0) {
  ...
  GetSetDate(registeringDate, startingDate, finishingDate) {
    ...
    this.dateFinishDisplay = finishingDate
      ? this.dateUtil.GetDate(new Date(finishingDate))
      : null;
  ...
  DisableSuggest(FormControl) {
    if (FormControl.includes('cim')) {
      this.initiativesForm.controls.cim.disable();
    }
    if (FormControl.includes('pim')) {
      this.initiativesForm.controls.pim.disable();
    }
    if (FormControl.includes('dim')) {
      this.initiativesForm.controls.dim.disable();
    }
    if (FormControl.includes('max')) {
    ...
    if (FormControl.includes('directCapex')) {
      this.initiativesForm.controls.directCapex.disable();
    }
  }
  ...
  SelectCoDeveloper() {
    if (this.initiativesForm.controls.coDeveloper.value) {
      this.initiativeService
        .UpdateCoDeveloper(
          this.id,
          this.initiativesForm.controls.coDeveloper.value
        )
        .subscribe(() => {
          this.CheckSwalType();
        });
      ...
      this.initiativeService
        .DeleteCoDeveloper(this.id)
        .subscribe(() => this.CheckSwalType());
    }
  }
  ...
  UpdateDraftInitiative() {
    ...
    this.initiativeService
      .UpdateDraftInitiative(this.id, this.initiativesForm.value)
      .subscribe(
        (response) => {
          sessionStorage.setItem('id', response.id.toString());
          this.GetSetDate(
            response.registeringDate,
            response.startingDate,
            response.finishingDate
          );
          this.initiativesForm.patchValue(response);
          this.initiativesForm.patchValue({
            registeringDate: this.dateRegisterDisplay,
  ...
  UpdateSubmitInitiative() {
    this.initiativesForm.patchValue({ updatedBy: this.username });
    this.initiativeService
      .UpdateSubmitInitiative(this.id, this.initiativesForm.value)
      .subscribe(
        (response) => {
          sessionStorage.setItem('id', response.id.toString());
          this.GetSetDate(
  ...
  CheckOther(event) {
    if (event.target.checked) {
      ...
      this.initiativesForm.patchValue({
        other: true,
        initiativeType: this.IsMax ? 'other,max' : 'other',
      });
    } else {
  ...
  CheckCpi(event) {
    if (event.target.checked) {
      ...
      this.initiativesForm.patchValue({
        cpi: true,
        initiativeType: this.IsMax ? 'cpi,max' : 'cpi',
      });
    } else {
  ...
  CheckStrategy(event) {
    if (event.target.checked) {
      ...
      this.initiativesForm.patchValue({
        strategy: true,
        initiativeType: this.IsMax ? 'strategy,max' : 'strategy',
      });
    } else {
  ...
  CheckRAndD(event) {
    if (event.target.checked) {
      ...
      this.initiativesForm.patchValue({
        randD: true,
        initiativeType: this.IsMax ? 'randD,max' : 'randD',
      });
    } else {
  ...
  CreateDraftInitiative() {
    this.initiativeService.CreateDraftInitiative(this.initiativesForm.value)
      .subscribe(
        (response) => {
          sessionStorage.setItem('id', response.id.toString());
          if (this.initiativesForm.controls.coDeveloper.value) {
  ...
  CreateSubmitInitiative() {
    this.initiativeService
      .CreateSubmitInitiative(this.initiativesForm.value)
      .subscribe(
        (response) => {
          sessionStorage.setItem('id', response.id.toString());
          if (this.initiativesForm.controls.coDeveloper.value) {
      ...
      case 'submit':
        if (
          ...
          sessionStorage.setItem(
            'InitiativeValidate',
            JSON.stringify(this.CheckValidForm)
          );
          ...
          setTimeout(
            () => this.router.navigate(['/initiative/detail-max']),
            1700
          );
        } else if (this.IsCapex && this.page === 'create' && !this.IsMax) {
          sessionStorage.setItem(
  ...
  GetCoDevelopers(Text?) {
    this.params.text = Text ? Text : '';
    this.initiativeService.GetCoDevelopers(this.params).subscribe(
      (coDevelopers) => {
  ...
  SetFormDate() {
    this.initiativesForm.patchValue({
      registeringDate: this.dateRegister
        ? this.dateRegister
  ...
  OnlyMax() {
    if (!this.CheckOnlyMax) {
      if (this.IsMax) {
        this.initiativesForm.patchValue({ initiativeType: 'max' });
      }
    }
  }
  ...
  SaveDraft() {
    this.initiativeService.UpdateAddMore(this.id, this.initiativesForm.value).subscribe(() => { });
  }
