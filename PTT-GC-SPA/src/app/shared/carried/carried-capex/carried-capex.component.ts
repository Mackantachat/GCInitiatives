...
@Component({
  selector: 'app-carried-capex',
  templateUrl: './carried-capex.component.html',
  styleUrls: ['./carried-capex.component.css']
})
export class CarriedCapexComponent implements OnInit {
  constructor(
  ...
  IsDetailCapex() {
    if (sessionStorage.getItem('isDetailCapex') === 'true') {
      ...
      setTimeout(() => {
        ...
        this.CarriedCost = DetailCapex.CarriedCost ? DetailCapex.CarriedCost : "";
  ...
  Savedraf() {
    ...
    this.capexService.GetCapexsInfo(this.id.toString(), 'Createnew').subscribe(resp_1 => {
      ...
      if (this.capexInformationId == null) {
