...
@Component({
  selector: 'app-addmore-pool',
  templateUrl: './addmore-pool.component.html',
  styleUrls: ['./addmore-pool.component.css']
})
export class AddmorePoolComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.type_pool = sessionStorage.getItem('type_pool');
    this.GetInitiative();
  ...
  CHk_validate_submit() {
    ...
    for (let i = 0; i < xx; i++) {
      ...
      if (control_month0.at(i).get('overall').value != (control_annual.at(i).get('y1').value * 1000000).toFixed(2)) {
    ...
    for (let i = 0; i < xx; i++) {
      ...
      if (control_month1.at(i).get('overall').value != "") {
        ...
        if (control_month1.at(i).get('overall').value != (control_annual.at(i).get('y2').value * 1000000).toFixed(2)) {
    ...
    for (let i = 0; i < xx; i++) {
      ...
      if (control_month2.at(i).get('overall').value != "") {
        if (control_month2.at(i).get('overall').value != (control_annual.at(i).get('y3').value * 1000000).toFixed(2)) {
    ...
    for (let i = 0; i < xx; i++) {
      ...
      if (control_month3.at(i).get('overall').value) {
        if (control_month3.at(i).get('overall').value != (control_annual.at(i).get('y4').value * 1000000).toFixed(2)) {
    ...
    for (let i = 0; i < xx; i++) {
      ...
      if (control_month4.at(i).get('overall').value != "") {
        if (control_month4.at(i).get('overall').value != (control_annual.at(i).get('y5').value * 1000000).toFixed(2)) {
    ...
    for (let i = 0; i < xx; i++) {
      ...
      if (control_month5.at(i).get('overall').value != "") {
        if (control_month5.at(i).get('overall').value != (control_annual.at(i).get('y6').value * 1000000).toFixed(2)) {
    ...
    for (let i = 0; i < xx; i++) {
      ...
      if (control_month6.at(i).get('overall').value) {
        ...
        if (control_month6.at(i).get('overall').value != (control_annual.at(i).get('y7').value * 1000000).toFixed(2)) {
    ...
    for (let i = 0; i < xx; i++) {
      ...
      if (control_month7.at(i).get('overall').value) {
        if (control_month7.at(i).get('overall').value != (control_annual.at(i).get('y8').value * 1000000).toFixed(2)) {
    ...
    for (let i = 0; i < xx; i++) {
      ...
      if (control_month8.at(i).get('overall').value != "") {
        if (control_month8.at(i).get('overall').value != (control_annual.at(i).get('y9').value * 1000000).toFixed(2)) {
    ...
    for (let i = 0; i < xx; i++) {
      ...
      if (control_month9.at(i).get('overall').value != "") {
        if (control_month9.at(i).get('overall').value != (control_annual.at(i).get('y10').value * 1000000).toFixed(2)) {
    ...
    this.capexService.GetCapexsInfo(this.id.toString(), 'Addmorepool').subscribe(resp_1 => {
      ...
      if (resp_1 == null) {
        ...
        if (this.capexType != "Addmorepool") {
          this.tmp_exist_projectcost = resp_1.projectCost;
          let tmpProjectCost = +this.tmp_exist_projectcost + +this.AdditionalCost;
          this.capexType = "Addmorepool";
      ...
      this.capexService.GetCapexsInfo_one(this.id.toString()).subscribe(resp => {
        ...
        if (this.type_pool == "addmore") {
          ...
          if (this.status != "revised") {
            if (response.capexStatus == "Submit" && response.capexType == "Addmorepool") {
              this.isNewAddmore = true;

              ExistingCost_ = response.projectCost;
              SpendingActual_ = response.spendingActual;
              BudgetAvailable_ = response.availableBudget;
              AdditionalCost_ = 0;

              ProjectCost_ = +ExistingCost_ + +AdditionalCost_;
