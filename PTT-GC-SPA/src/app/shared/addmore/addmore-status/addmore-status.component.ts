...
@Component({
  selector: 'app-addmore-status',
  templateUrl: './addmore-status.component.html',
  styleUrls: ['./addmore-status.component.css']
})
export class AddmoreStatusComponent implements OnInit {
