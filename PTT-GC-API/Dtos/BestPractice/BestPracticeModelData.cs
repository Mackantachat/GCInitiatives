...
namespace PTT_GC_API.Dtos.BestPractice
{
    public class BestPracticeModelData
    {
        ...
        public List<string> KnowledgeContributor { get; set; }
        public List<Contact> ContactModel { get; set; }
        public List<ProjectReferenceModel> ProjectReferenceModel { get; set; }
        public List<Milestone> MileStoneModel { get; set; }
    }
}
