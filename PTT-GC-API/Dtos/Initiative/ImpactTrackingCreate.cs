...
namespace PTT_GC_API.Dtos.Initiative
{
    public class ImpactTrackingCreate
    {
        ...
        public CreateWorkstream ShareBenefitFrom { get; set; }
        public FirstRunRateCreate FirstRunRateForm { get; set; }
        public FirstRunRateTable FirstRunRateTotalForm { get; set; }
        public TypeBenefitCreate TypeBenefitForm { get; set; }
        public TypeBenefitTable TypeBenefitTotalForm { get; set; }
        public IndirectCreate IndirectForm { get; set; }
        public ImpiemantCostCreate ImpiemantCostForm { get; set; }
