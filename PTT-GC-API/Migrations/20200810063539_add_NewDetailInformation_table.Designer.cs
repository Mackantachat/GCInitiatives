...
namespace PTT_GC_API.Migrations
{
    ...
    [Migration("20200810063539_add_NewDetailInformation_table")]
    partial class add_NewDetailInformation_table
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PTT_GC_API.Models.Initiative.NewDetailInformation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PTT_GC_API.Models.OriginalRisk", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("ExitingImpact")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ExitingLikelihood")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("MitigationImpact")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("MitigationLikelihood")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("RiskLevelAfterExitingControl")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("RiskLevelExpected")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("RiskNo")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.ToTable("OriginalRisks");
                });
            ...
            modelBuilder.Entity("PTT_GC_API.Models.ResourceNeeded.ResourceNeeded", b =>
                {
                    ...
                    b.Property<bool?>("IsUtilityRequired")
                        .HasColumnType("bit");

                    b.Property<bool?>("IsUtilityTableRequired")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("PTT_GC_API.Models.ResourceNeeded.TimelineTable", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<decimal?>("SupplyPeriods")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("PTT_GC_API.Models.RiskAction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PTT_GC_API.Models.RiskHeaders", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("ApprovePeriod")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("PTT_GC_API.Models.RiskTable", b =>
                {
                    b.Property<int>("RiskId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
